  ...
  return (
    <section className="relative isolate overflow-hidden py-16 dark:text-white">
      ...
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-2">
          {chips.map((c) => (
            <span
              key={c}
              className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-semibold text-black/90 backdrop-blur-md dark:text-white/90"
            >
              {c}
            </span>
          ))}
      ...
      <div className="mx-auto mt-14 max-w-5xl rounded-3xl border border-white/10 bg-white/[0.03] px-6 py-12 backdrop-blur-xl">
        ...
        <h3 className={` mb-10 text-3xl font-bold`}>How I ship features</h3>
      ...
      <div className="mx-auto mt-20 max-w-5xl">
        ...
        <h3 className={` mb-10 text-3xl font-bold`}>What collaborators say</h3>
