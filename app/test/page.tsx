...
export default function Profile() {
  return (
    ...
    //     some knowledge in Android development and a strong drive to inspire and
    //     mentor upcoming developers worldwide.
    //   </p>
    //   <h4>Social tags</h4>
    ...
    //   <ul>
    //     <li>
    //       I'm currently working on a project called DevsQuest, a web application
    //       for developers.
    //     </li>
    //     <li>Learning solidity for web3 and smart contract development.</li>
    //     <li>
    //       Looking to collaborate with other developers on the DevsQuest project.
    //     </li>
    ...
    //   <p>
    //     It is meant to connect and build communities of developers where we can
    //     organize, link, and build working teams for educational and development
    //     purposes. Catch phrase: Code and Coffee. I'll be building it gradually
    //     and adding new features with time, and hopefully launch it soon. In the
    //     end, it should have games, challenges, collaborations, blogs, and a
    //     forum. The project is part of my learning of React and when I'm
    //     proficient enough, I'll be able to develop it further.
    //   </p>
    //   <h4>A bit more</h4>
    //   <p>
    //     I love engineering, IoT, programming, and computers. It all started with
    //     an old IBM computer that we had at home. Back then, we only drew stuff
    //     with Microsoft Paint, but I grew curious about how it worked and
    //     everything about it. And voila, here I am learning and developing using
    //     the same curiosity. The little things and steps are key. Keep learning
    //     and write it all down in code. Did I mention I'm also a marine
    //     engineering student? Well, that's what I do at the Technical University
    //     of Mombasa.
    //   </p>
    //   <h4>Likes</h4>
    //   <ul>
