...
export function FloatingSocialBar() {
  return (
    <div className="fixed left-14 top-1/2 z-50 hidden -translate-y-1/2 flex-col items-center gap-6 lg:flex 2xl:left-24">
      {/* Vertical line */}
      <div className="h-16 w-[2px] bg-indigo-400 shadow-[0_0_10px_rgba(251,191,36,0.6)]" />
      ...
      {/* Bottom line */}
      <div className="h-16 w-[2px] bg-slate-500/40" />
    </div>
  );
}
