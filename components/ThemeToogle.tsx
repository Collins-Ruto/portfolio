  ...
  if (!mounted)
    return (
      <div className="">
        <div
          className={` ${
            place == "mobile-toogle" || place == "nav-toogle"
              ? "xl:hidden"
              : "hidden"
          } themebutton flex `}
          // key={place}
        >
          <input
            type="checkbox"
            checked={false} // Hardcode to a default
            readOnly
          ></input>
          <label htmlFor={`darkmode-mob-toggle-${place}`}>
            <span
              className={`
            ...
            >
              {checked ? (
                <ThemeIcons mode="moon" checked />
              ) : (
                <ThemeIcons mode="sun" checked />
              )}
            </span>
          </label>
        </div>
        <div
          ...
          ${
            place === "nav-toogle"
              ? "hidden xl:flex" // only visible on large screens
              : place === "mobile-toogle"
              ? "flex max-md:hidden" // only visible on small screens
              : place === "sidebar-toogle"
              ? "flex" // always visible
              : "hidden"
          }
          themetoogle
...
function ThemeIcons({
  ...
  // Reuse the same SVGs you already use in the pill version.
  // If your current ThemeToogle.tsx already contains SVG markup, paste it here verbatim.
  // Below are lightweight inline SVGs (no dependency).
